import management from "../../src/assets/management.svg";

const SocialHero = () => {
  return (
    <div className="flex flex-col md:flex-row items-center md:w-full md:px-[100px] gap-10 justify-evenly px-4 mt-10 md:mt-10">
      <div className="flex flex-col  md:items-start items-center md:w-full py-10 md:py-20 mb-10 md:basis-1/2">
        <h1 className=" text-center md:text-start text-[30px] md:text-[58px] leading-[45px] md:leading-[59px]  font-semibold text-white">
          Engage and Grow Your
          <br /> Audience with
          <br /> Professional
